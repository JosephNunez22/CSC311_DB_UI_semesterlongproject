...
public class DbConnectivityClass {
    ...
    final static String MYSQL_SERVER_URL = "jdbc:mysql://nuneja38000.mysql.database.azure.com/";
    final static String DB_URL = MYSQL_SERVER_URL + "nuneja38000";
    final static String USERNAME = "nuneja38";
    final static String PASSWORD = "FARM123$";

    private static DbConnectivityClass instance;

    private DbConnectivityClass() {}
    
    public static synchronized DbConnectivityClass getInstance() {
        if (instance == null) {
